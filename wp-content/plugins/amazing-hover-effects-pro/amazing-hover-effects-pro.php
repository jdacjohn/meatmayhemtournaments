<?php
/*
Plugin Name: Amazing Hover Effects Pro
...
function amazing_hover_effects_style() {
	...
	wp_enqueue_style('ahew_stylesheet_square-2', plugins_url( 'css/square-2.css' , __FILE__ ) );
	wp_enqueue_style('ahew_stylesheet_caption', plugins_url( 'css/caption.css' , __FILE__ ) );
	wp_enqueue_style('ahew_stylesheet_others', plugins_url( 'css/others.css' , __FILE__ ) );
	wp_enqueue_style('ahew_stylesheet_custom', plugins_url( 'css/custom.css' , __FILE__ ) );
	//wp_enqueue_style('ahew_responsive', plugins_url( 'css/responsive.css' , __FILE__ ) );
