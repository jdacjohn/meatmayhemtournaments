			...
			<div class="sixteen columns">
					...
					<div class="logo">
						<?php if($data['media_logo'] != "") { ?>
							<a href="https://www.makoboats.com/boat/?boat=4106" target="_blank"><img src="<?php echo $data['media_logo']; ?>" alt="<?php bloginfo('name'); ?>" class="logo_standard" /></a>
						...
						<?php } else { ?>
							<a href="https://www.makoboats.com/boat/?boat=4106" target="_blank"><?php bloginfo('name'); ?></a>
						<?php } ?>
					</div>
